---
title: 🌼 Dandelion = 👹 MolochDAO + 🦅 Aragon
author: 1Hive team
...
4) Proposals should require the proposer to lock tokens in order to ensure that the incentives of voters are aligned with their votes
...
We started working on Redemptions before our [Aragon Nest](https://github.com/aragon/nest/) grant was approved and it is currently available on Rinkeby. The [Redemptions app Github Repo](https://github.com/1Hive/redemptions-app) has more details and deployment instructions.
